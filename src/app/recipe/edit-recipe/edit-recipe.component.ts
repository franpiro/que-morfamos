...
export class EditRecipeComponent implements OnInit {
  ...
  public prexistentImageUrl;
  public prexistentImageName;
  private recipeId;
  ...
  ngOnInit(): void {
    ...
    this.recipeService.getRecipeById(this.activatedRoute.snapshot.paramMap.get('id')).subscribe((recipe) => { 
      ...
      recipe.ingredients.forEach(x => (this.recipeForm.get('ingredients') as FormArray).push(this.createIngredientFormGroup({ingredient: { id: x.id, name: x.name }, quantity: Number(x.quantity) })))
